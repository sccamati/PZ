...
namespace lab2
{
	public class Programista : Pracownik
    {
		...
		public Programista(int liczba_Wykorzystywanych_Technologii, int numerIdentyfikacyjny, string imie, string nazwisko, int wiek, decimal pensja) 
		...
		{
			base.ZwiekszPensje(pieniadze * Liczba_Wykorzystywanych_Technologii);
		}
	}
}
